...
[2026-09-13 19:13:55 UTC] Context study: Primary hardware captures: 3/8 complete; Q4_K_M decode/GPU0 accepted and Q2_K matching decode/GPU0 capture started.
[2026-09-13 19:15:44 UTC] Context study: Q2_K decode/GPU0 warmup is progressing; 3/8 primary captures are complete and the broader inference sweep remains paused.
[2026-09-13 19:16:45 UTC] Context study: Q2_K entered the recorded decode/GPU0 capture; paired eight-request decode interpretation awaits its completed counter report.
[2026-09-13 19:17:49 UTC] Context study: Q2_K decode/GPU0 capture continues normally; 3 accepted primary reports are preserved, with no external GPU workload detected.
[2026-09-13 19:19:01 UTC] Context study: Q2_K decode/GPU0 recorded burst has passed three-quarters of its 512-token outputs; first paired decode counter report is approaching completion.
[2026-09-13 19:20:15 UTC] Context study: Q2_K decode/GPU0 burst finished; Nsight report creation/parsing is underway before accepting and comparing the counters.
[2026-09-13 19:22:18 UTC] Context study: First paired decode/GPU0 gate-up result: Q2 reads 41.6% fewer DRAM bytes, executes 35.2% more instructions, and takes 26.4% longer; registers 125->151/thread, occupancy 31.8%->23.83%, no spills; GPU1 and width/dispatch controls remain pending.
[2026-09-13 19:24:34 UTC] Context study: FINDINGS.md now includes paired GPU0 prefill and decode mechanisms, with replay and causal-scope limits; 4/8 primary captures complete and Q4_K_M prefill/GPU1 is active.
[2026-09-13 19:26:13 UTC] Context study: Q4_K_M prefill/GPU1 burst finished and its counter report is finalizing; Q2_K matching prefill/GPU1 capture is next.
[2026-09-13 19:27:45 UTC] Context study: Primary hardware captures: 5/8 complete; Q2_K prefill/GPU1 is loading, followed by the two GPU1 decode captures.
[2026-09-13 19:28:57 UTC] Context study: Q2_K prefill/GPU1 warmup is nearing completion; no external GPU workload or service swap detected.
[2026-09-13 19:30:09 UTC] Context study: Q2_K recorded prefill/GPU1 burst started; this pair will check the GPU0 prefill instruction-overhead result on the second device.
[2026-09-13 19:31:30 UTC] Context study: Q2_K prefill/GPU1 capture is progressing normally; 5/8 primary reports complete, current report still collecting.
[2026-09-13 19:32:46 UTC] Context study: Primary hardware captures: 6/8 complete; paired prefill reports available on both GPUs, with Q4_K_M decode/GPU1 now active before the final Q2_K decode capture.
[2026-09-13 19:33:15 UTC] Context study: GPU1 confirms prefill mechanism: Q2 instruction/opcode counts match GPU0 exactly (+69.6% instructions), DRAM reads -30.1%, duration +48.0%; FINDINGS.md updated with GPU1 evidence, while two decode captures and controls remain.
[2026-09-13 19:35:03 UTC] Context study: Q4_K_M decode/GPU1 warmup is progressing; two primary captures remain, followed by isolated width and dispatch checks.
[2026-09-13 19:36:01 UTC] Context study: Q4_K_M recorded decode/GPU1 capture started; completed reports preserved and broader serving sweep still stopped.
[2026-09-13 19:36:59 UTC] Context study: Q4_K_M decode/GPU1 counter replay remains active; no new completed report yet.
[2026-09-13 19:38:00 UTC] Context study: Q4_K_M decode/GPU1 run is generating responses after initial counter replay work and progressing normally.
[2026-09-13 19:38:57 UTC] Context study: Q4_K_M decode/GPU1 burst is past halfway; Q2_K decode on GPU1 is the last remaining primary capture afterward.
[2026-09-13 19:40:04 UTC] Context study: Q4_K_M decode/GPU1 burst is nearing 512 outputs; final Q2_K primary capture follows report finalization.
[2026-09-13 19:41:00 UTC] Context study: Primary hardware captures: 7/8 complete; final Q2_K decode/GPU1 capture started, followed by the isolated width/dispatch tests and final findings consolidation.
[2026-09-13 19:42:29 UTC] Context study: Final Q2_K decode/GPU1 capture is warming up; seven accepted primary captures preserved and no inference benchmarks repeated.
[2026-09-13 19:43:24 UTC] Context study: Final Q2_K decode/GPU1 warmup is nearly finished; its recorded counter burst is next.
[2026-09-13 19:44:22 UTC] Context study: Final Q2_K recorded decode/GPU1 burst started; acceptance will complete the 2-format x 2-phase x 2-GPU primary counter set.
[2026-09-13 19:45:55 UTC] Context study: Final Q2_K decode/GPU1 capture is progressing; reviewing stall breakdown to distinguish instruction work from data-memory and instruction-fetch waits.
[2026-09-13 19:47:38 UTC] Context study: Final primary capture is nearing completion; GPU0 decode instruction-fetch stall ratio is small and equal (0.02 cycles/issued instruction) for Q2/Q4, while instruction count and register use differ.
[2026-09-13 19:49:01 UTC] Context study: All 8 primary 70B Q2/Q4 counter captures complete and GPUs verified idle; isolated trace-selected matrix tests started under the same zero-swap service, broader serving still paused.
[2026-09-13 19:49:53 UTC] Context study: Isolated matrix tests are running (first 10 timing/counter records complete); GPU1 confirms decode: Q2 instructions +35.2%, duration +25.8%, DRAM reads -41.6%, with the same register/occupancy pattern as GPU0.
[2026-09-13 19:50:33 UTC] Context study: Controlled GPU0 gate/up timing reproduces crossover: Q2/Q4 151/198 us at width1, 486/425 us at width8, 262/283 us at width9; width8 dispatch-only intervention is being checked, with single-matrix timing distinct from fused serving latency.
[2026-09-13 19:51:29 UTC] Context study: GPU0 dispatch control: Q2 gate/up width8 operation 485.7->214.3 us (-55.9%); new MMQ path executes about 78% fewer total-path instructions with roughly unchanged DRAM reads, supporting dispatch/arithmetic cost; down-projection and GPU1 checks ongoing.
[2026-09-13 19:53:14 UTC] Context study: Isolated matrix tests are about halfway through; first-GPU results show the dispatch effect, with down-projection and second-GPU confirmation continuing.
[2026-09-13 19:55:31 UTC] Context study: Isolated matrix tests: 84/88 timing/counter records complete; four records remain for GPU1 down-projection checks; preparing consolidated results and the width-dependent ranking plot.
[2026-09-13 19:57:02 UTC] Context study: All targeted measurements complete: 8 primary server captures plus 44 isolated cases with one timing run and one counter capture each (88 records); both GPUs idle, final analysis/report/plot checks underway; broader serving remains paused.
[2026-09-13 20:00:17 UTC] Context study: Final targeted checks PASS: 8 matched server captures and 44 timing + 44 counter records; consolidated report/CSVs/plot written, final FINDINGS.md wording and visual review underway.
[2026-09-13 20:07:39 UTC] Context study: Targeted 70B Q2/Q4 investigation complete; FINDINGS.md now links paired counters, isolated dispatch controls and plot; both GPUs idle, CPU-only report index refresh finishing, broader sweep paused.
[2026-09-13 20:07:52 UTC] Context study: Targeted 70B Q2/Q4 analysis finished: paired counters and dispatch controls explain extra instruction work; FINDINGS.md, focused report/plot and shared result index updated; measurements validated, GPUs idle, broader study remains paused.
[2026-09-13 21:46:51 UTC] Context study: Preparing a concise 70B paper with separate Runtime Cost and Runtime Bottlenecks sections, using completed measurements and the reference paper/article structure; no GPU experiments started.
[2026-09-13 21:56:41 UTC] Context study: 70B paper draft and figures written; tightening the PDF to three pages and checking numeric provenance/layout, with Runtime Cost and Runtime Bottlenecks separated and no new GPU work.
[2026-09-13 21:58:17 UTC] Context study: Three-page 70B paper complete in paper/llama70b.pdf and .md, with separate Runtime Cost/Runtime Bottlenecks, two figures and two tables; numeric/link/layout checks passed; no GPU experiments run, broader study remains paused.
[2026-09-13 22:16:28 UTC] Context study: Reviewed completed runtime plots/settings: IQ1_M has a C16 throughput dip across all 8B prompt lengths; concurrency gains shrink with longer inputs; equal aggregate prompt budgets yield different output throughput; Q4/FP16 rates converge at long context. New mechanisms remain unprofiled; no experiments launched.
[2026-09-13 22:22:27 UTC] Context study: Confirmed chunked prefill with continuous batching: 2048-token logical budget, 512-token physical microbatches; 70B traces show pure-prefill width 512 and mixed prompt/decode batches; no experiments launched.
[2026-09-13 22:24:48 UTC] Context study: Confirmed 70B Q2/Q4 lower-bit latency counterexamples at C8/P8k and P16k; C8/P64k excluded before launch because FP16 KV alone requires 161.875 GiB; no 64k runtime measurement or new experiment.
[2026-09-13 22:32:46 UTC] Context study: Preparing four distinct poster plots from saved measurements: 70B paired latency and concurrency-gain bars, 8B IQ1_M concurrency lines and FP16/Q4 dumbbells; requested 64k estimate will be separate and explicitly illustrative, with capacity and donor-protocol limitations.
[2026-09-13 22:41:31 UTC] Context study: Completed four Runtime Cost poster figures and combined layout in paper/poster (PNG/PDF/SVG), plus a separate labeled 64k illustration; numeric, link and layout checks passed; README links added; canonical measurements unchanged and broader GPU study remains paused.
[2026-09-13 23:07:53 UTC] Context study: Preparing alternate two-line Runtime Cost PDF: 8B C32 throughput normalized to FP16 and 8B C8-to-C16 throughput changes for all five formats; keeping the 70B latency annotation explicitly separate and preserving the original four-panel poster.
[2026-09-13 23:09:16 UTC] Context study: Alternate two-line poster complete: paper/poster/runtime-cost-two-line.pdf (also PNG/SVG), all five formats on 8B, explicitly separate 70B latency callout and IQ1_M recovery; 40 derived values and layout checked; original poster preserved, no GPU work.
